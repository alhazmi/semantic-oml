...
(function (window, undefined) { // trick: safekeep 'undefined', and minify.
    ...
    S.namespace = (function () {
		...
		'omn-monitoring-data' : "http://open-multinet.info/ontology/omn-monitoring-data#",
		'omn-monitoring-genericconcepts' : "http://open-multinet.info/ontology/omn-monitoring-genericconcepts#",
		'omn-monitoring-metric' : "http://open-multinet.info/ontology/omn-monitoring-metric#",
		'omn-monitoring-unit' : "http://open-multinet.info/ontology/omn-monitoring-unit#",
		'omn-monitoring-tool' : "http://open-multinet.info/ontology/omn-monitoring-tool#",
		'omn-monitoring' : "http://open-multinet.info/ontology/omn-monitoring#",
		'omn' : "http://open-multinet.info/ontology/omn#",
		'omn-resource' : "http://open-multinet.info/ontology/omn-resource#",
		'omn-lifecycle' : "http://open-multinet.info/ontology/omn-lifecycle#",
		'omn-domain-pc' : "http://open-multinet.info/ontology/omn-domain-pc#",
        'omn-federation' : "http://open-multinet.info/ontology/omn-federation#",
        'omn-service' : "http://open-multinet.info/ontology/omn-service#",
        'omn-component' : "http://open-multinet.info/ontology/omn-component#",
        'omn-policy' : "http://open-multinet.info/ontology/omn-policy#"
            },
    ...
    S.parser = (function () {
        ...
        return {
            ...
            convertJSON: function (stable) {
			    ...
			    /*if(!isNaN(srow[scols[c]].value)){
                            	gdatatype[c] = 'number';
                                gcols[c].type = gdatatype[c];
                            }
			    if(isDate(srow[scols[c]].value)){
                                gdatatype[c] = 'datetime';
                                gcols[c].type = gdatatype[c];
                            }*/
        ...
        var util = S.util,
            ...
            */
            ...
            draw = function (containerId) {
				...
				if(myChart.split(".")[2] != "Table"){
                                    var unit, prefix ;
                                    for (var i = dataTable.getNumberOfColumns()-1; i >= 0 ; i--) {
                                            if(dataTable.getColumnLabel(i).toLowerCase() == "unit"){
                                                unit = dataTable.getValue(1,i).split("#")[1];
                                                dataTable.removeColumn(i) ;
                                            } else if(dataTable.getColumnLabel(i).toLowerCase() == "prefix"){
                                                prefix = dataTable.getValue(1,i).split("#")[1];
                                                dataTable.removeColumn(i) ;
                                            }
                                    }
                                    if(prefix || unit){
					    if((typeof unit !== "undefined") && (typeof prefix !== "undefined")){
				 		unit = "in ".concat(prefix, unit) ;
					    }
				   	    else if((typeof unit == "undefined") && (typeof prefix != "undefined")){
						unit = "in ".concat(prefix, unit) ;
					    }
					    if(myChart.split(".")[2] != "BarChart"){
                                                customOpt = {
                                                    vAxis: {
                                                            title: unit
                                                    }} ;
                                            ...
                                            chartOptions = $.extend(defaults.getChartOptions(), customOpt);
                                    }
                                }
