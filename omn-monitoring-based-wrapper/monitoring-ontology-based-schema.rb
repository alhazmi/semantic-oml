...
#
# This template contains user-defined schemas based on OMN ontology including a set of measurement metrics.
...
app.defMeasurement("used_memory"){ |m|
    ...
    [['omn-monitoring:Measurement','omn-monitoring:isMeasurementOf','omn-monitoring-metric:UsedMemory'],
...
app.defMeasurement("total_memory"){ |m|
    ...
    [['omn-monitoring:Measurement','omn-monitoring:isMeasurementOf','omn-monitoring-metric:TotalMemory'],
...
app.defMeasurement("available_memory"){ |m|
    ...
    [['omn-monitoring:Measurement','omn-monitoring:isMeasurementOf','omn-monitoring-metric:AvailableMemory'],
...
app.defMeasurement("used_bandwidth"){ |m|
    ...
    [['omn-monitoring:Measurement','omn-monitoring:isMeasurementOf','omn-monitoring-metric:UsedBandwidth'],
...
app.defMeasurement("availability"){ |m|
    ...
    [['omn-monitoring:Measurement','omn-monitoring:isMeasurementOf','omn-monitoring-metric:Availability'],
